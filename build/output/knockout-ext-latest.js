...
(function(f){var d=function(){var b=ko.utils;return{a:b.unwrapObservable,c:b.registerEventHandler,d:b.toggleDomNodeCssClass}}();f.html={update:function(b,c){var a=d.a(c());if(a===null||a===undefined)a="";b.innerHTML=a}};f.event={init:function(b,c,a,e){c=d.a(c());for(var g in c)if(typeof g=="string"){var j=d.a(c[g]);d.c(b,g,function(h,k,l,m){var i;try{i=j.call(e,b,h,k,l,m)}finally{if(!i)if(h.preventDefault)h.preventDefault();else h.returnValue=false}})}}};f.attr={update:function(b,c){var a=d.a(c()||
{}),e;for(e in a)if(typeof e=="string"){var g=d.a(a[e]);b.setAttribute(e,g)}}};f.className={update:function(b,c){var a=c();a=d.a(a);if(typeof a=="function")a=a();a=a.split(" ");for(var e=0,g=a.length;e<g;++e)d.d(b,d.a(a[e]),true)}}})(ko.bindingHandlers);
